...
ParseRule rules[] = {
    ...
    [TOKEN_DOT]           = {NULL,     (int(*)(int))dotAccess, PREC_CALL},
    [TOKEN_ELLIPSIS]      = {vararg,   NULL,    PREC_NONE},
    [TOKEN_COLON]         = {NULL,     (int(*)(int))methodCall, PREC_CALL},
    ...
    [TOKEN_PERCENT] = {NULL, (int(*)(int))binary, PREC_FACTOR},
    [TOKEN_BANG]          = {unary,    NULL,    PREC_NONE},
    [TOKEN_NOT]           = {unary,    NULL,    PREC_NONE},
    [TOKEN_HASH]          = {unary,    NULL,    PREC_NONE},
    [TOKEN_QUESTION]      = {NULL,     (int(*)(int))ternary, PREC_TERNARY},
